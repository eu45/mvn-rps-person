...
<title>购物车</title>
	...
	<%@ include file="/view/comman/head.jsp"%>
...
<body>
	...
	<div id="header">
		...
		<%--静态包含，登录 成功之后的菜单 --%>
		<%@ include file="/view/comman/login_success_menu.jsp"%>
	...
	<div id="main">
		...
		<c:if test="${not empty sessionScope.cart.items}">
			<div class="cart_info">
				...
				<span class="cart_span"><a href="orderService?action=createOrder">去结账</a></span>
			</div>
		</c:if>
